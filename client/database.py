...
class ClientDatabase:
    """Класс работы с базой данных клиента."""
    ...
    class MessageStat:
        """Статистика переданных сообщений."""
    ...
    def get_contacts(self):
        """Возврат списока всех контактов."""
        return [contact[0] for contact in self.session.query(self.Contacts.name).all()]

    def get_users(self):
        """Возврат всех известных пользователей."""
    ...
    def get_history(self, contact):
        """История сообщений с определённым пользователем."""
